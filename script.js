...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const amOpeningValueSpan = document.getElementById('am-opening-value');
    const amAddedValueSpan = document.getElementById('am-added-value');
    ...
    const pmClosingValueSpan = document.getElementById('pm-closing-value');
    const totalAddedValueSpan = document.getElementById('total-added-value');
    ...
    const updateTotals = () => {
        ...
        amShiftBody.querySelectorAll('tr').forEach(row => {
            ...
            amOpeningValue += opening * price;
            amAddedValue += added * price;
        });
        amTotalSpan.textContent = amTotal.toFixed(2);
        amOpeningValueSpan.textContent = amOpeningValue.toFixed(2);
        amAddedValueSpan.textContent = amAddedValue.toFixed(2);
        ...
        pmShiftBody.querySelectorAll('tr').forEach(row => {
            ...
            pmClosingValue += closing * price;
            pmAddedValue += added * price;
        });
        pmTotalSpan.textContent = pmTotal.toFixed(2);
        pmClosingValueSpan.textContent = pmClosingValue.toFixed(2);
        totalAddedValueSpan.textContent = (amAddedValue + pmAddedValue).toFixed(2);
